    ...
    <section id="hero" className="min-h-screen flex items-center justify-center pt-[80px] px-[24px]">
      <div className="max-w-[1200px] w-full grid md:grid-cols-2 gap-[48px] items-center">
        <div className="order-2 md:order-1 text-center md:text-left">
          ...
          <p className="text-[18px] font-[500] text-blue-400 uppercase tracking-[4px] mb-[24px]">
            IoT Engineer | Full-Stack Developer
          </p>
          <p className="text-[16px] text-slate-400 leading-[1.6] max-w-[500px] mb-[40px] mx-auto md:mx-0">
            I build smart, automated solutions that bridge the gap between hardware and software, focusing on reliability and elegant design.
          </p>
          <div className="flex flex-wrap gap-[16px] justify-center md:justify-start">
            <a href="#projects" className="px-[32px] py-[14px] rounded-full bg-blue-600 text-white font-[700] text-[13px] uppercase tracking-[2px] hover:bg-blue-500 hover:shadow-[0_0_30px_rgba(37,99,235,0.4)] transition-all transform hover:-translate-y-1">
              View Projects
            </a>
          </div>
        </div>
        ...
        <div className="order-1 md:order-2 flex flex-col items-center gap-[24px]">
          ...
          <a href="/Dulara_Abhishek_CV.pdf" download className="group flex items-center gap-[12px] px-[24px] py-[12px] rounded-[16px] bg-slate-900 border border-slate-800 text-slate-300 hover:border-blue-500 hover:text-white transition-all shadow-xl">
            <span className="text-[12px] font-[700] uppercase tracking-[2px]">Download CV</span>
