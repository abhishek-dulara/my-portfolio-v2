  ...
  return (
    <section id="insights" className="min-h-screen py-[100px] px-[24px] bg-slate-950/40">
      <div className="max-w-[1200px] mx-auto w-full">
        <h2 className="text-[30px] font-[800] uppercase tracking-[4px] text-blue-500 mb-[16px]">Insights</h2>
        <h3 className="text-[30px] font-[700] text-white mb-[48px]">Recent LinkedIn Updates</h3>
        ...
        <div className="grid md:grid-cols-2 gap-[24px]">
          {posts.map((post) => (
            ...
            >
              ...
              <h4 className="text-[25px] font-[700] text-white mb-[16px] group-hover:text-blue-400 transition-colors">
                {post.title}
              </h4>

              <p className="text-[20px] text-slate-400 leading-[1.8] mb-[24px]">
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="inline-block text-blue-500 font-[700] uppercase tracking-[2px] text-[15px] 
